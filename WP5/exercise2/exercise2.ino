...
#define DHTPIN 12      // Digital pin connected to the DHT11 sensor
...
#define WHITE_LED 10  // Pin for the white that is yellow LED
...
#define DELAY_PERIOD 1000  // Delay 5 seconds
...
void updateLeds(float temperature) {
  ...
  if (temperature <= TEMP_RANGE_1) {
    ...
    //digitalWrite(RED_LED, HIGH); // for debbuging purposes
    //digitalWrite(YELLOW_LED, HIGH);
    //digitalWrite(GREEN_LED, HIGH);
    //digitalWrite(BLUE_LED, HIGH);
